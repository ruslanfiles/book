...
//|   - Вход: пересечение EMA(21)/EMA(50) в сторону тренда старших    |
//|           ТФ + ADX (сила тренда) + фильтр RSI + ATR               |
...
input bool     InpUseStochastic    = false;         // Стохастик (для долгосрочной ВЫКЛ → триггер = кросс EMA)
input int      InpStochK           = 9;             // Стохастик %K
